...
public class MainMenuController : MonoBehaviour {
    ...
    public void Runner(string level1)
    {
        SceneManager.LoadScene(level1);
    }
    public void Car(string level1)
    {
        SceneManager.LoadScene(level1);
    }
    public void SASTRA(string level1)
    {
        SceneManager.LoadScene(level1);
    }
    ...
    public void LoadSceneDartmouth(string level1)
    {
        SceneManager.LoadScene("Dartmouth-DALI");
    }
